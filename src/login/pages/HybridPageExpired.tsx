...
export default function HybridPageExpired(props: PageProps<Extract<KcContext, { pageId: "login-page-expired.ftl" }>, I18n>) {
    ...
    return (
        ...
        >
            <div className="space-y-6 text-center">
                ...
                <p className="text-gray-600">{msg("pageExpiredMsg1")}</p>
